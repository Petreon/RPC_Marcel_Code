...
// functions
double Deriv_L(double B, double L, double H, Eigen::MatrixXd rpcNumerator, Eigen::MatrixXd rpcDenominator)
{
...
*/
    ...
    /*
    Derivate for L value in relation of the Rpc's the calculus is based in this octave line:
    Using the Eigen we need to decrease -1 in indexes, because octave/matlab uses >1 indexes for array/matrices

    x = (rpc_num(14)*H^2 + 2*rpc_num(18)*H*L + rpc_num(11)*H*B + rpc_num(6)*H + 3*rpc_num(12)*L^2 + 2*rpc_num(15)*L*B + 2*rpc_num(8)*L + rpc_num(13)*B^2 + rpc_num(5)*B + rpc_num(2)   ) /    ( rpc_den(20)*H^3 + rpc_den(14)*H^2*L + rpc_den(17)*H^2*B + rpc_den(10)*H^2 + rpc_den(18)*H*L^2 + rpc_den(11)*H*L*B + rpc_den(6)*H*L + rpc_den(19)*H*B^2 + rpc_den(07)*H*B + rpc_den(4)*H + rpc_den(12)*L^3 + rpc_den(15)*L^2*B + rpc_den(8)*L^2 + rpc_den(13)*L*B^2 + rpc_den(5)*L*B + rpc_den(2)*L + rpc_den(16)*B^3 + rpc_den(9)*B^2 + rpc_den(3)*B + rpc_den(1)) -  ( rpc_den(14)*H^2 + 2*rpc_den(18)*H*L + rpc_den(11)*H*B + rpc_den(6)*H + 3*rpc_den(12)*L^2 + 2*rpc_den(15)*L*B + 2*rpc_den(8)*L + rpc_den(13)*B^2 + rpc_den(5)*B + rpc_den(2))  *    (rpc_num(20)*H^3 + rpc_num(14)*H^2*L + rpc_num(17)*H^2*B + rpc_num(10)*H^2 + rpc_num(18)*H*L^2 + rpc_num(11)*H*L*B + rpc_num(6)*H*L + rpc_num(19)*H*B^2 + rpc_num(7)*H*B + rpc_num(4)*H + rpc_num(12)*L^3 + rpc_num(15)*L^2*B + rpc_num(8)*L^2 + rpc_num(13)*L*B^2 + rpc_num(5)*L*B + rpc_num(2)*L + rpc_num(16)*B^3 + rpc_num(9)*B^2 + rpc_num(3)*B + rpc_num(1))    /    ( rpc_den(20)*H^3 + rpc_den(14)*H^2*L + rpc_den(17)*H^2*B + rpc_den(10)*H^2 + rpc_den(18)*H*L^2 + rpc_den(11)*H*L*B + rpc_den(6)*H*L + rpc_den(19)*H*B^2 + rpc_den(7)*H*B + rpc_den(4)*H + rpc_den(12)*L^3 + rpc_den(15)*L^2*B + rpc_den(8)*L^2 + rpc_den(13)*L*B^2 + rpc_den(5)*L*B + rpc_den(2)*L + rpc_den(16)*B^3 + rpc_den(9)*B^2 + rpc_den(3)*B + rpc_den(1))^2;
    ...
    // part 1:
    /*
    (rpc_num(14)*H^2 + 2*rpc_num(18)*H*L + rpc_num(11)*H*B + rpc_num(6)*H + 3*rpc_num(12)*L^2 + 2*rpc_num(15)*L*B + 2*rpc_num(8)*L + rpc_num(13)*B^2 + rpc_num(5)*B + rpc_num(2)   )
    */
    double part1 = (rpcNumerator.row(13).value() * std::pow(H, 2) + (double)2 * rpcNumerator.row(17).value() * H * L + rpcNumerator.row(10).value() * H * B + rpcNumerator.row(5).value() * H + (double)3 * rpcNumerator.row(11).value() * std::pow(L, 2) + (double)2 * rpcNumerator.row(14).value() * L * B + 2 * rpcNumerator.row(7).value() * L + rpcNumerator.row(12).value() * std::pow(B, 2) + rpcNumerator.row(4).value() * B + rpcNumerator.row(1).value());

    // part 2:
    /*
    ( rpc_den(20)*H^3 + rpc_den(14)*H^2*L + rpc_den(17)*H^2*B + rpc_den(10)*H^2 + rpc_den(18)*H*L^2 + rpc_den(11)*H*L*B + rpc_den(6)*H*L + rpc_den(19)*H*B^2 + rpc_den(07)*H*B + rpc_den(4)*H + rpc_den(12)*L^3 + rpc_den(15)*L^2*B + rpc_den(8)*L^2 + rpc_den(13)*L*B^2 + rpc_den(5)*L*B + rpc_den(2)*L + rpc_den(16)*B^3 + rpc_den(9)*B^2 + rpc_den(3)*B + rpc_den(1))
    */
    ...
    // part 3:
    /*
    ( rpc_den(14)*H^2 + 2*rpc_den(18)*H*L + rpc_den(11)*H*B + rpc_den(6)*H + 3*rpc_den(12)*L^2 + 2*rpc_den(15)*L*B + 2*rpc_den(8)*L + rpc_den(13)*B^2 + rpc_den(5)*B + rpc_den(2))
    */
    double part3 = (rpcDenominator.row(13).value() * std::pow(H, 2) + (double)2 * rpcDenominator.row(17).value() * H * L + rpcDenominator.row(10).value() * H * B + rpcDenominator.row(5).value() * H + (double)3 * rpcDenominator.row(11).value() * std::pow(L, 2) + (double)2 * rpcDenominator.row(14).value() * L * B + (double)2 * rpcDenominator.row(7).value() * L + rpcDenominator.row(12).value() * std::pow(B, 2) + rpcDenominator.row(4).value() * B + rpcDenominator.row(1).value());
